...
def paste_back(temp_vision_frame : VisionFrame, crop_vision_frame : VisionFrame, crop_vision_mask : Mask, affine_matrix : Matrix) -> VisionFrame:
	from facefusion.vision_enhanced import paste_back_enhanced
	return paste_back_enhanced(temp_vision_frame, crop_vision_frame, crop_vision_mask, affine_matrix)
