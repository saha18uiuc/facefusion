...
def create_execution_program() -> ArgumentParser:
	...
	group_execution.add_argument('--gpu-mode', help = translator.get('help.gpu_mode'), dest = 'gpu_mode', action = 'store_true', default = config.get_bool_value('execution', 'gpu_mode', 'False'))
	job_store.register_job_keys([ 'execution_device_ids', 'execution_providers', 'execution_thread_count', 'gpu_mode' ])
	return program
